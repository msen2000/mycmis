 ...
 * on 2014-03-31 at 07:07:42 UTC 
 * Modify at your own risk.
 */

package org.sen.example.mobileassistant.checkinendpoint;
...
public class Checkinendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetCheckIn extends CheckinendpointRequest<org.sen.example.mobileassistant.checkinendpoint.model.CheckIn> {
    ...
    protected GetCheckIn(java.lang.Long id) {
      super(Checkinendpoint.this, "GET", REST_PATH, null, org.sen.example.mobileassistant.checkinendpoint.model.CheckIn.class);
   ...
   * operation.
   *
   * @param content the {@link org.sen.example.mobileassistant.checkinendpoint.model.CheckIn}
   * @return the request
   */
  public InsertCheckIn insertCheckIn(org.sen.example.mobileassistant.checkinendpoint.model.CheckIn content) throws java.io.IOException {
    InsertCheckIn result = new InsertCheckIn(content);
    initialize(result);
    return result;
  }

  public class InsertCheckIn extends CheckinendpointRequest<org.sen.example.mobileassistant.checkinendpoint.model.CheckIn> {
     ...
     * @since 1.13
     */
    protected InsertCheckIn(org.sen.example.mobileassistant.checkinendpoint.model.CheckIn content) {
      super(Checkinendpoint.this, "POST", REST_PATH, content, org.sen.example.mobileassistant.checkinendpoint.model.CheckIn.class);
    }
  ...
  public class ListCheckIn extends CheckinendpointRequest<org.sen.example.mobileassistant.checkinendpoint.model.CollectionResponseCheckIn> {
    ...
    protected ListCheckIn() {
      super(Checkinendpoint.this, "GET", REST_PATH, null, org.sen.example.mobileassistant.checkinendpoint.model.CollectionResponseCheckIn.class);
    }
   ...
   * @return the request
   */
  public UpdateCheckIn updateCheckIn(org.sen.example.mobileassistant.checkinendpoint.model.CheckIn content) throws java.io.IOException {
    UpdateCheckIn result = new UpdateCheckIn(content);
    initialize(result);
    return result;
  }

  public class UpdateCheckIn extends CheckinendpointRequest<org.sen.example.mobileassistant.checkinendpoint.model.CheckIn> {
     ...
     * @since 1.13
     */
    protected UpdateCheckIn(org.sen.example.mobileassistant.checkinendpoint.model.CheckIn content) {
      super(Checkinendpoint.this, "PUT", REST_PATH, content, org.sen.example.mobileassistant.checkinendpoint.model.CheckIn.class);
    }
