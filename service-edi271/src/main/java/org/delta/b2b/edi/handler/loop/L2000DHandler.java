...
public class L2000DHandler {
	...
	public L2000DHandler(L2000D obj, Row row) {
		l2000d = obj; 		
		process(row);
	}
	...
	public void process(Row row) {
		...
		if ("PRV".equalsIgnoreCase(segName)) {
			...
			SPRVProviderInformation1 sprv = objFac.createSPRVProviderInformation1();
			EPRV01ProviderCode2 eprv01 = new EPRV01ProviderCode2();			
			...
			*/
			...
			JAXBElement<SPRVProviderInformation1> jaxsprv = new JAXBElement(QName.valueOf("S-PRV-Provider_Information"), SPRVProviderInformation1.class, null, sprv);
