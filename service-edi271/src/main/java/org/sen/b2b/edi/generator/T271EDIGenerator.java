...
public class T271EDIGenerator implements EDIGenerator { 
	...
	private T271 t271;
	private StringBuilder str271 = new StringBuilder();
	...
	public T271EDIGenerator(T271 t271){
		this.t271 = t271;
	}
		
	@Override
	public String generateEDI() {
		str271.append(generateSISA());
		str271.append(segSeperator);
		str271.append(generateSGS());
		str271.append(segSeperator);
		str271.append(generateSST());		
		str271.append(segSeperator);
		str271.append(generateSBHT());
		
		str271.append(segSeperator);
		str271.append(generateSHL());
		
		str271.append(segSeperator);
		str271.append(generateSSE());
		str271.append(segSeperator);
		str271.append(generateSGE());
		str271.append(segSeperator);
		str271.append(generateSIEA());
		
		return str271.toString();
	}
	...
	public String generateSIEA(){
		SIEAInterchangeControlTrailer siea = t271.getSIEAInterchangeControlTrailer();
		if(null == siea) 
			return "";
	...
	public String generateSGE(){
		SGEFunctionalGroupTrailer sge = t271.getSGEFunctionalGroupTrailer();
	...
	public String generateSSE(){
		SSETransactionSetTrailer sse = t271.getSSETransactionSetTrailer();
		if(null == sse) 
			return "";
	...
	public String generateSBHT(){
		SBHTBeginningOfHierarchicalTransaction sbht = t271.getSBHTBeginningOfHierarchicalTransaction();
		if(null == sbht) 
			return "";
		StringBuilder strBul = new StringBuilder();		
		strBul.append("BHT");
		...
		if(null != sbht.getEBHT06TransactionTypeCode()) 
			strBul.append(sbht.getEBHT06TransactionTypeCode().getValue().getType());
		strBul.append(eleSeperator);
	...
	public String generateSST(){
		SSTTransactionSetHeader sst = t271.getSSTTransactionSetHeader();
		if(null == sst) 
			return "";
	...
	public String generateSGS(){
		SGSFunctionalGroupHeader sgs = t271.getSGSFunctionalGroupHeader();
		if(null == sgs)
			return null;
	...
	public String generateSISA() {
		SISAInterchangeControlHeader isa = t271.getSISAInterchangeControlHeader();		
		if(null == isa) 
			return "";		
