...
import org.sen.b2b.edi.t276.EISA01AuthorizationInformationQualifier;
import org.sen.b2b.edi.t276.EISA03SecurityInformationQualifier;
import org.sen.b2b.edi.t276.EISA04SecurityInformation;
import org.sen.b2b.edi.t276.EISA06InterchangeSenderID;
import org.sen.b2b.edi.t276.EISA07InterchangeIDQualifier;
import org.sen.b2b.edi.t276.EISA08InterchangeReceiverID;
import org.sen.b2b.edi.t276.EISA09InterchangeDate;
import org.sen.b2b.edi.t276.EISA11RepetitionSeparator;
import org.sen.b2b.edi.t276.EISA12InterchangeControlVersionNumber;
import org.sen.b2b.edi.t276.EISA13InterchangeControlNumber;
import org.sen.b2b.edi.t276.EISA14AcknowledgmentRequested;
import org.sen.b2b.edi.t276.EISA15InterchangeUsageIndicator;
import org.sen.b2b.edi.t276.EISA16ComponentElementSeparator;
import org.sen.b2b.edi.t276.SISAInterchangeControlHeader;
import org.sen.b2b.edi.t276.T276;
import org.sen.b2b.edi.t276.EISA02AuthorizationInformation;
import org.sen.b2b.edi.t276.EISA05InterchangeIDQualifier;
import org.sen.b2b.edi.t276.EISA10InterchangeTime;

public class ISAHandler {

	private SISAInterchangeControlHeader isah;
	
	public ISAHandler(T276 t276, Row row) {
		isah = t276.getSISAInterchangeControlHeader(); 
		process(row);
	}
