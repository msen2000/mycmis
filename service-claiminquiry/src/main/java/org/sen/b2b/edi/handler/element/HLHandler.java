...
import org.sen.b2b.edi.t276.EHL01HierarchicalIDNumber;
import org.sen.b2b.edi.t276.EHL02HierarchicalParentIDNumber;
import org.sen.b2b.edi.t276.EHL02HierarchicalParentIDNumber1;
import org.sen.b2b.edi.t276.EHL03HierarchicalLevelCode;
import org.sen.b2b.edi.t276.EHL03HierarchicalLevelCode1;
import org.sen.b2b.edi.t276.EHL03HierarchicalLevelCode2;
import org.sen.b2b.edi.t276.EHL03HierarchicalLevelCode3;
import org.sen.b2b.edi.t276.EHL04HierarchicalChildCode;
import org.sen.b2b.edi.t276.EHL04HierarchicalChildCode1;
import org.sen.b2b.edi.t276.EHL04HierarchicalChildCode2;
...
public class HLHandler {
	...
	public HLHandler(T276 t276, Row row) {
		list = t276.getL2000AOrL2000BOrL2000C(); 	
	...
	public void process(Row row) {
		...
		if("L2000A".equalsIgnoreCase(currentLoopName)) {
			...
			if(arr.length == 4) {
				EHL04HierarchicalChildCode2 e04 = new EHL04HierarchicalChildCode2();
				//e04.setValue(arr[3]);
				//hl.setEHL04HierarchicalChildCode(e04);
			}
