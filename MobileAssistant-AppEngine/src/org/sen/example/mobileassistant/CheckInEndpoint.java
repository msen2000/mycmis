...
import org.sen.example.mobileassistant.EMF;
...
@Api(name = "checkinendpoint", namespace = @ApiNamespace(ownerDomain = "sen.org", ownerName = "sen.org", packagePath = "example.mobileassistant"))
public class CheckInEndpoint {
	...
	public CheckIn insertCheckIn(CheckIn checkin) {
		EntityManager mgr = getEntityManager();
		try {
// TODO: Per the Tutorial, deleting the following lines.
