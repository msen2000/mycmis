...
public class L2000DHandler {
	...
	private L2000D l2000d;
		
	public L2000DHandler(L2000D obj, EDIRow row) {
		l2000d = obj; 		
		process(row);
	}
	...
	public void process(EDIRow row) {
		...
		if ("EQ".equalsIgnoreCase(segName)) {
			...
			/*
			CC003CompositeMedicalProcedureIdentifier cc003 = new CC003CompositeMedicalProcedureIdentifier();
			cc003.setEEQ01ProductServiceIDQualifier(null);
			cc003.setEEQ02ProductServiceID(null);	
			JAXBElement<CC003CompositeMedicalProcedureIdentifier> jaxcc003 = new JAXBElement(QName.valueOf("C-C003-Composite_Medical_Procedure_Identifier"), CC003CompositeMedicalProcedureIdentifier.class, null, cc003);			
			seq.setCC003CompositeMedicalProcedureIdentifier(jaxcc003);
			
			CC004CompositeDiagnosisCodePointer cc004 = new CC004CompositeDiagnosisCodePointer();
			cc004.setEEQ01DiagnosisCodePointer(null);
			cc004.setEEQ02DiagnosisCodePointer(null);
			cc004.setEEQ03DiagnosisCodePointer(null);
			cc004.setEEQ04DiagnosisCodePointer(null);
			JAXBElement<CC004CompositeDiagnosisCodePointer> jaxcc004 = new JAXBElement(QName.valueOf("C-C004-Composite_Diagnosis_Code_Pointer"), CC004CompositeDiagnosisCodePointer.class, null, cc004);
			seq.setCC004CompositeDiagnosisCodePointer(jaxcc004);
			*/
