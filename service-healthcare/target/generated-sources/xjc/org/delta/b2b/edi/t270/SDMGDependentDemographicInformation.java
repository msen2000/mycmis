 ...
 *       &lt;sequence>
 *         &lt;element name="E-DMG01-Date_Time_Period_Format_Qualifier" type="{http://www.delta.org/b2b/edi/t270}E-DMG01-Date_Time_Period_Format_Qualifier" minOccurs="0"/>
 *         &lt;element name="E-DMG02-Date_Time_Period" type="{http://www.delta.org/b2b/edi/t270}E-DMG02-Date_Time_Period" minOccurs="0"/>
 *         &lt;element name="E-DMG03-Gender_Code" type="{http://www.delta.org/b2b/edi/t270}E-DMG03-Gender_Code" minOccurs="0"/>
 *         &lt;element name="E-DMG04-Marital_Status_Code" type="{http://www.delta.org/b2b/edi/t270}E-DMG04-Marital_Status_Code" minOccurs="0"/>
 *         &lt;element name="C-C056-Composite_Race_or_Ethnicity_Information" type="{http://www.delta.org/b2b/edi/t270}C-C056-Composite_Race_or_Ethnicity_Information" maxOccurs="10" minOccurs="0"/>
 *         &lt;element name="E-DMG06-Citizenship_Status_Code" type="{http://www.delta.org/b2b/edi/t270}E-DMG06-Citizenship_Status_Code" minOccurs="0"/>
 *         &lt;element name="E-DMG07-Country_Code" type="{http://www.delta.org/b2b/edi/t270}E-DMG07-Country_Code" minOccurs="0"/>
 *         &lt;element name="E-DMG08-Basis_of_Verification_Code" type="{http://www.delta.org/b2b/edi/t270}E-DMG08-Basis_of_Verification_Code" minOccurs="0"/>
 *         &lt;element name="E-DMG09-Quantity" type="{http://www.delta.org/b2b/edi/t270}E-DMG09-Quantity" minOccurs="0"/>
 *         &lt;element name="E-DMG10-Code_List_Qualifier_Code" type="{http://www.delta.org/b2b/edi/t270}E-DMG10-Code_List_Qualifier_Code" minOccurs="0"/>
 *         &lt;element name="E-DMG11-Industry_Code" type="{http://www.delta.org/b2b/edi/t270}E-DMG11-Industry_Code" minOccurs="0"/>
 *       &lt;/sequence>
...
public class SDMGDependentDemographicInformation {
    ...
    @XmlElementRef(name = "E-DMG01-Date_Time_Period_Format_Qualifier", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
    protected JAXBElement<EDMG01DateTimePeriodFormatQualifier> edmg01DateTimePeriodFormatQualifier;
    @XmlElementRef(name = "E-DMG02-Date_Time_Period", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
    protected JAXBElement<EDMG02DateTimePeriod> edmg02DateTimePeriod;
    @XmlElementRef(name = "E-DMG03-Gender_Code", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
    protected JAXBElement<EDMG03GenderCode> edmg03GenderCode;
    @XmlElementRef(name = "E-DMG04-Marital_Status_Code", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "E-DMG06-Citizenship_Status_Code", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
    protected JAXBElement<EDMG06CitizenshipStatusCode> edmg06CitizenshipStatusCode;
    @XmlElementRef(name = "E-DMG07-Country_Code", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
    protected JAXBElement<EDMG07CountryCode> edmg07CountryCode;
    @XmlElementRef(name = "E-DMG08-Basis_of_Verification_Code", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
    protected JAXBElement<EDMG08BasisOfVerificationCode> edmg08BasisOfVerificationCode;
    @XmlElementRef(name = "E-DMG09-Quantity", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
    protected JAXBElement<EDMG09Quantity> edmg09Quantity;
    @XmlElementRef(name = "E-DMG10-Code_List_Qualifier_Code", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
    protected JAXBElement<EDMG10CodeListQualifierCode> edmg10CodeListQualifierCode;
    @XmlElementRef(name = "E-DMG11-Industry_Code", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
