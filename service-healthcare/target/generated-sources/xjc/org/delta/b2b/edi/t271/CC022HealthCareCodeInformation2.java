 ...
 *       &lt;/sequence>
 *       &lt;attribute name="ApplicationInfo" type="{http://www.w3.org/2001/XMLSchema}string" fixed="Required when it is necessary to report an additional diagnoses and the preceeding HI data elements have been used to report other diagnoses. If not required, do not send." />
...
public class CC022HealthCareCodeInformation2 {
    ...
    public String getApplicationInfo() {
        if (applicationInfo == null) {
            return "Required when it is necessary to report an additional diagnoses and the preceeding HI data elements have been used to report other diagnoses. If not required, do not send.";
        } else {
