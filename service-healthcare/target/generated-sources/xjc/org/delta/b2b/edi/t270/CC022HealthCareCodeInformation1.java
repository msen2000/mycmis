 ...
 *       &lt;sequence>
 *         &lt;element name="E-HI01-Code_List_Qualifier_Code" type="{http://www.delta.org/b2b/edi/t270}E-HI01-Code_List_Qualifier_Code_1"/>
 *         &lt;element name="E-HI02-Industry_Code" type="{http://www.delta.org/b2b/edi/t270}E-HI02-Industry_Code"/>
 *         &lt;element name="E-HI03-Date_Time_Period_Format_Qualifier" type="{http://www.delta.org/b2b/edi/t270}E-HI03-Date_Time_Period_Format_Qualifier" minOccurs="0"/>
 *         &lt;element name="E-HI04-Date_Time_Period" type="{http://www.delta.org/b2b/edi/t270}E-HI04-Date_Time_Period" minOccurs="0"/>
 *         &lt;element name="E-HI05-Monetary_Amount" type="{http://www.delta.org/b2b/edi/t270}E-HI05-Monetary_Amount" minOccurs="0"/>
 *         &lt;element name="E-HI06-Quantity" type="{http://www.delta.org/b2b/edi/t270}E-HI06-Quantity" minOccurs="0"/>
 *         &lt;element name="E-HI07-Version_Identifier" type="{http://www.delta.org/b2b/edi/t270}E-HI07-Version_Identifier" minOccurs="0"/>
 *         &lt;element name="E-HI08-Industry_Code" type="{http://www.delta.org/b2b/edi/t270}E-HI08-Industry_Code" minOccurs="0"/>
 *         &lt;element name="E-HI09-Yes_No_Condition_or_Response_Code" type="{http://www.delta.org/b2b/edi/t270}E-HI09-Yes_No_Condition_or_Response_Code" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attribute name="ApplicationInfo" type="{http://www.w3.org/2001/XMLSchema}string" fixed="Required when it is necessary to report an additional diagnoses and the preceeding HI data elements have been used to report other diagnoses. If not required by this implementation guide, do not send." />
...
public class CC022HealthCareCodeInformation1 {
    ...
    @XmlElementRef(name = "E-HI03-Date_Time_Period_Format_Qualifier", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
    protected JAXBElement<EHI03DateTimePeriodFormatQualifier> ehi03DateTimePeriodFormatQualifier;
    @XmlElementRef(name = "E-HI04-Date_Time_Period", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
    protected JAXBElement<EHI04DateTimePeriod> ehi04DateTimePeriod;
    @XmlElementRef(name = "E-HI05-Monetary_Amount", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
    protected JAXBElement<EHI05MonetaryAmount> ehi05MonetaryAmount;
    @XmlElementRef(name = "E-HI06-Quantity", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
    protected JAXBElement<EHI06Quantity> ehi06Quantity;
    @XmlElementRef(name = "E-HI07-Version_Identifier", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
    protected JAXBElement<EHI07VersionIdentifier> ehi07VersionIdentifier;
    @XmlElementRef(name = "E-HI08-Industry_Code", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
    protected JAXBElement<EHI08IndustryCode> ehi08IndustryCode;
    @XmlElementRef(name = "E-HI09-Yes_No_Condition_or_Response_Code", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
    ...
    public String getApplicationInfo() {
        if (applicationInfo == null) {
            return "Required when it is necessary to report an additional diagnoses and the preceeding HI data elements have been used to report other diagnoses. If not required by this implementation guide, do not send.";
        } else {
