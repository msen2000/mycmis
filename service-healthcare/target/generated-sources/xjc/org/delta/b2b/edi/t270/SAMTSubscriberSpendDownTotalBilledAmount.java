 ...
 * 
 * <p>Java class for S-AMT-Subscriber_Spend_Down_Total_Billed_Amount complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="S-AMT-Subscriber_Spend_Down_Total_Billed_Amount">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="E-AMT01-Amount_Qualifier_Code" type="{http://www.delta.org/b2b/edi/t270}E-AMT01-Amount_Qualifier_Code_1"/>
 *         &lt;element name="E-AMT02-Monetary_Amount" type="{http://www.delta.org/b2b/edi/t270}E-AMT02-Monetary_Amount"/>
 *         &lt;element name="E-AMT03-Credit_Debit_Flag_Code" type="{http://www.delta.org/b2b/edi/t270}E-AMT03-Credit_Debit_Flag_Code" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attribute name="ID" type="{http://www.w3.org/2001/XMLSchema}string" default="AMT" />
 *       &lt;attribute name="Name" type="{http://www.w3.org/2001/XMLSchema}string" default="Subscriber Spend Down Total Billed Amount" />
...
@XmlType(name = "S-AMT-Subscriber_Spend_Down_Total_Billed_Amount", propOrder = {
    "eamt01AmountQualifierCode",
    "eamt02MonetaryAmount",
    "eamt03CreditDebitFlagCode"
})
public class SAMTSubscriberSpendDownTotalBilledAmount {

    @XmlElement(name = "E-AMT01-Amount_Qualifier_Code", required = true)
    protected EAMT01AmountQualifierCode1 eamt01AmountQualifierCode;
    @XmlElement(name = "E-AMT02-Monetary_Amount", required = true)
    protected EAMT02MonetaryAmount eamt02MonetaryAmount;
    @XmlElementRef(name = "E-AMT03-Credit_Debit_Flag_Code", namespace = "http://www.delta.org/b2b/edi/t270", type = JAXBElement.class)
     ...
     * @return
     *     possible object is
     *     {@link EAMT01AmountQualifierCode1 }
     *     
     */
    public EAMT01AmountQualifierCode1 getEAMT01AmountQualifierCode() {
     ...
     *     
     */
    public void setEAMT01AmountQualifierCode(EAMT01AmountQualifierCode1 value) {
    ...
    public String getName() {
        if (name == null) {
            return "Subscriber Spend Down Total Billed Amount";
        } else {
            return name;
        }
    }
